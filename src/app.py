...
activities = {
    ...
    "Basketball Team": {
        "description": "Compete in competitive basketball tournaments and friendly matches",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["james@mergington.edu"]
    },
    "Tennis Club": {
        "description": "Learn and practice tennis skills with coaching and tournaments",
    ...
    "Science Club": {
        "description": "Conduct experiments and explore STEM topics including robotics",
